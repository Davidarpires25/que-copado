...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the admin email (index 6).
        ...
        # -> Click the sidebar 'Productos' link to open the admin products management page (element index 1362).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[3]/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the sidebar 'Productos' link again to open the admin products management page (element index 1362).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[3]/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
