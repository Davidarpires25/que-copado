...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Pedidos' (Orders) link in the sidebar to open the orders management page and then wait for it to load.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[2]/div[2]/a[4]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
