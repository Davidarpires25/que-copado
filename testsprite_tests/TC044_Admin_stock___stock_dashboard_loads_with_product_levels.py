...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided credential and then the password, then click 'Iniciar Sesion' to log in.
        ...
        # -> Click the 'Stock' link in the sidebar (index 2383) to open the stock page, then inspect the page for product stock levels and a register-purchase option.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[2]/div[2]/a[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
