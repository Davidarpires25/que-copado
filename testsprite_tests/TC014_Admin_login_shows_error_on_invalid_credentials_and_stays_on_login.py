...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password with invalid credentials, submit the form, wait for response, and extract notifications text to verify an error toast appears and that the page did not navigate away.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div[2]/div/div[2]/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('invalid-admin@example.com')
