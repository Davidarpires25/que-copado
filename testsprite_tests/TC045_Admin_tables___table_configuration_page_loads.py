...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Iniciar Sesion' button to log in, then wait for redirect to /admin/dashboard.
        ...
        # -> Open the 'Mesas' (tables) page by clicking the sidebar 'Mesas' link and then verify the page shows the configured tables list and an Add button.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[2]/div[2]/a[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Open the tables configuration page (/admin/tables) to verify the configured tables list and presence of an Add button.
