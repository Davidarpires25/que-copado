...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided email, fill the password, and click 'Iniciar Sesion' to log in.
        ...
        # -> Click the 'Categorías' link in the left sidebar to open the categories management page and verify the categories list is displayed.
        frame = context.pages[-1]
        # Click element
