...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the provided credentials and click the 'Iniciar Sesion' button, then wait for the redirect.
        ...
        # -> Click the 'Cocina' link in the sidebar (index 2765) to open the kitchen display, wait for the page to load, then extract page text to check for pending orders or an empty state.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/aside/nav/div[2]/div[2]/a[5]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
