...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Iniciar Sesion' submit button to log in.
        ...
        # -> Open the 'Ingredientes' page by clicking the sidebar link, then verify the ingredients list shows columns for name, unit and cost.
        frame = context.pages[-1]
        # Click element
