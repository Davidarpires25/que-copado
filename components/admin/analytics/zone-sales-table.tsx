      ...
      {data.map((zone) => {
        ...
        return (
          <div
            ...
            className="space-y-2 group p-2 -mx-2 rounded-lg hover:bg-[var(--admin-surface-2)] transition-colors duration-200"
          >
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                <div
                  className="w-3 h-3 rounded-full shrink-0 ring-2 ring-transparent group-hover:ring-offset-2 group-hover:ring-offset-[var(--admin-surface-2)] transition-all"
                  style={{ backgroundColor: zone.zoneColor }}
                />
                <span className="text-[var(--admin-text)] text-sm font-medium truncate">
                  {zone.zoneName}
                </span>
            ...
            <div className="h-2 bg-[var(--admin-bg)] rounded-full overflow-hidden ml-5">
              <div
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 ml-5 text-xs text-[var(--admin-text-muted)]">
