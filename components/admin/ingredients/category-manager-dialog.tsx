                  ...
                  {editingId === category.id ? (
                    <>
                      ...
                      <Button
                        size="icon"
                        variant="ghost"
                        className="h-8 w-8 text-green-700 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 hover:bg-green-50 dark:hover:bg-green-950/30 shrink-0"
